...
public class PlayerControllerX : MonoBehaviour
{
	...
	private float upBoundary = 15f; // change
    ...
    void Update()
    {
        ...
        {
            playerRb.AddForce(Vector3.up * floatForce * Time.deltaTime, ForceMode.VelocityChange);
        }
		if(transform.position.y < 0f)
		{
			playerRb.AddForce(Vector3.up * 40f * Time.deltaTime, ForceMode.Impulse);
		}
    }
